package priv.eric.pelee.application.util;
...
public class PluginRegistry {
     ...
     * 获取所有StageContext实现
     */
    public static List<StageContext> getAllStageContexts() {
        return (List<StageContext>) StageContextLoader.getInstance().getAllStageContexts();
    }
